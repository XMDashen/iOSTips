...
scheme_name="DongDongWedding"
# 工程中Target对应的配置plist文件名称, Xcode默认的配置文件为Info.plist
info_plist_name="Info"

# 蒲公英   (若果使用了可以蒲公英可以在此填写相关参数)
pgyerUKey="8a668ac7e6904e52a9b76da6f55b6f5e"
pgyerApiKey="e6a4165e6082425288edd458cfa85672"
pgyerDownloadUrl="https://www.pgyer.com/ugSA"
