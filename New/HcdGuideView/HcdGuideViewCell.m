...
//    button.titleLabel.font = [UIFont systemFontOfSize:16];
    button.titleLabel.font = [UIFont fontWithName:@"Al Nile" size:17];
    ...
    [self.button setCenter:CGPointMake(kHcdGuideViewBounds.size.width / 2, kHcdGuideViewBounds.size.height - 60)];
}
